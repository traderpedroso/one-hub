...
func GetDefaultPrice() []*Price {
	ModelTypes := map[string]ModelType{
		...
		"gemini-1.5-flash-001":                   {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-1.5-flash-001-tuning":            {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-1.5-flash-002":                   {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		...
		"gemini-1.5-pro-001":                     {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-1.5-pro-002":                     {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash":                       {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-001":                   {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-exp":                   {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-exp-image-generation":  {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-lite":                  {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-lite-001":              {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-lite-preview":          {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-lite-preview-02-05":    {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-thinking-exp":          {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-thinking-exp-01-21":    {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-flash-thinking-exp-1219":    {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-pro-exp":                     {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-2.0-pro-exp-02-05":               {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemini-exp-1206":                        {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"gemma-3-27b-it":                         {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		"learnlm-1.5-pro-experimental":           {[]float64{0.06, 0.06}, config.ChannelTypeGemini},
		...
		"gemini-ultra":                            {[]float64{0.06, 0.06}, config.ChannelTypeGemini},oat64{1, 1}, config.ChannelTypeGemini},
